...
class Api {
    ...
    final response = await _client
        .post(
          ...
          body: jsonEncode({
            ...
            if (landmark.isNotEmpty) 'land_mark': landmark,
            ...
            if (customField1.isNotEmpty) 'custom_field1': customField1,
            if (customField2.isNotEmpty) 'custom_field2': customField2,
            if (customField3.isNotEmpty) 'custom_field3': customField3,
            if (customField4.isNotEmpty) 'custom_field4': customField4,
          }),
        )
        .timeout(const Duration(seconds: 20));
  ...
  Customer _customerFromJson(Map<String, dynamic> json) => Customer(
    ...
    address: [
      ...
      json['state'],
      json['country'],
      json['land_mark'] ?? json['landmark'],
      json['street_name'],
      json['building_number'],
      json['additional_number'],
    ].where((value) => value?.toString().trim().isNotEmpty == true).join(', '),
    ...
    landmark: (json['land_mark'] ?? json['landmark'])?.toString() ?? '',
