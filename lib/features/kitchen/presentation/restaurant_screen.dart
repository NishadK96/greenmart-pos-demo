...
import 'kitchen_pos_screen.dart'
    show KitchenOrderDetailsDialog, kitchenOrdersProvider;
...
class _RestaurantScreenState extends ConsumerState<RestaurantScreen> {
  ...
  Future<void> _showKitchenOrderDetails(Sale order) => showDialog<void>(
    ...
    builder: (_) => KitchenOrderDetailsDialog(
      order: order,
      onPreviewBill: () => _previewKitchenOrderBill(order),
      onPrintBill: () => _printKitchenOrderBill(order),
      onPrintKitchenTicket: order.serverId == null
          ? null
